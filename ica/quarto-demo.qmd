...
stored under, portfolio, and under the ICA folder
Toggling between the .qmd and .html files, explain the purpose of the following features in the .qmd file:        

`*`changes the words to italic

`**`makes the word like a title 
...
it runs a one and another one.
In the website its cleaner, and theres aslso a drop down menue to see the code. 
