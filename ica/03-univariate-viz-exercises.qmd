...
> From the graph, we can learn that there are more then 25 people who rated their hikes as moderate, and there are less then half of that amount of people who rated the hike as easy.
> And a lower number of people who rated the hike as diffucult.
...
> the x axsis is not in order from easy, moderate, difficult.
> To make the graph more conscise it would be better to put them in order.
...
> this might not be a great graph to look at because its hard to desipsher where the averages of the hikes are.
> It makes it diffucult to answer the question and to find the range of how the hikes are distributed.
